    ...
    <section className="container bod">
      <div className="row py-4">
        <div className="col-md-6 col-12">
          <h1 className="h1-bod">The Future <br/>Belongs to <span className="text-green"><br/>Advanced Tech</span></h1>
          <h2 className="py-5">Switch to <span className="text-vol">#Innovation</span></h2>
          <div className="row">
